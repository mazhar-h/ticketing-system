...
export class RegisterComponent {
  ...
  registrationType = 'User'; // Default registration type
  ...
  onSubmit(event: Event) {
    ...
    switch (this.registrationType) {
      case 'User':
        ...
        break;
      case 'Performer':
        this.performerService.register({ name, username, email, password }).subscribe({
          next: (response: any) => {
            this.router.navigate(['/']);
          },
          error: (error: any) => {
        ...
        break;
      case 'Venue':
        this.venueService.register({ name, username, email, password, address, state, zipcode }).subscribe({
          next: (response: any) => {
            this.router.navigate(['/']);
          },
          error: (error: any) => {
